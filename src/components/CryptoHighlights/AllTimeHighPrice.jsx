...
useEffect(() => {
  ...
  return (
    <div className=" max-w-[95vw] mx-auto relative top-[30vh]  bg-white rounded-xl shadow-lg p-2 ">
    {/* Header */}
    <div className="flex items-center justify-between mb-4 p-2">
      <div className="flex items-center gap-2">
        <SlGraph className="text-orange-500 text-xl" />
        <h2 className="text-lg font-semibold text-black"> Price Change since ATH (%) </h2>
      </div>
